    ...
    def run_pipeline(
        ...
        try:
            ...
            try:
                ...
                target_max_seconds = float(os.environ.get("TARGET_MAX_SECONDS", "32"))
                target_min_seconds = float(os.environ.get("TARGET_MIN_SECONDS", "28"))
            ...
            try:
                ...
                target_min = float(os.environ.get("TARGET_MIN_SECONDS", "28"))

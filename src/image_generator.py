...
def _generate_one(index, scene, used_hashes: set, used_fallbacks: set):
    ...
    # AI motion clips via Seedance — PRIORITIZED OVER STOCK (original feel)
# Custom provider order: pollinations > original > pixabay > pexels > ai_horde when POLLINATIONS_KEY is set) is the

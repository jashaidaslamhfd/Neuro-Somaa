...
_Generated 2026-08-07T06:43:33.846947+00:00_
## Executive summary
- Videos in history: **46**
...
- [Réveil avant l'alarme](https://youtu.be/1XVYcxQqDqo) → **Pourquoi se réveiller avant son réveil ?** (`low views after 438h: 154 < 200`)
...
- [Ce que votre corps vous dit quand le corps se fige](https://youtu.be/0V5ZhO3qviQ) → **Pourquoi le corps se fige quand on a peur ?** (`low views after 408h: 146 < 200`)
...
- [Ce que votre corps vous dit quand le silence devient](https://youtu.be/TaXxSn0YoMc) → **Pourquoi le silence devient inconfortable ?** (`low views after 382h: 116 < 200`)
...
- **illusion** — new gap, score 10.619 (competitor_tag, competitor_title)
- **youtube** — new gap, score 10.619 (competitor_tag, competitor_title)
- **métal** — new gap, score 7.108 (competitor_title)
- **destructeur** — new gap, score 7.108 (competitor_title)
- **chimie** — new gap, score 7.108 (competitor_title)
- **mateooo** — new gap, score 6.715 (competitor_title)
- **enfants** — new gap, score 6.715 (competitor_title)
- **voient** — new gap, score 6.715 (competitor_title)
- **personne** — new gap, score 6.715 (competitor_title)
- **handicapée** — new gap, score 6.715 (competitor_title)
- **animation** — new gap, score 6.715 (competitor_title)
- **humour** — new gap, score 6.715 (competitor_title)
- **faux** — new gap, score 6.707 (competitor_title)
- **bébés** — new gap, score 6.707 (competitor_title)
- **sont** — new gap, score 6.707 (competitor_title)

## Latest uploads
- 2026-08-07T00:46:45.979567+00:00: Pourquoi l'œil distingue plus de nuances de vert ? (n/a views)
...
- 2026-08-05T08:16:11.417005+00:00: Pourquoi les mains se fripent dans l'eau ? (n/a views)
- 2026-08-05T07:52:55.711900+00:00: Pourquoi les oreilles deviennent chaudes ? (n/a views)
- 2026-08-05T07:45:24.523625+00:00: Pourquoi la voix tremble par nervosité ? (n/a views)
